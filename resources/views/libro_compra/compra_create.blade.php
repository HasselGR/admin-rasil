...
@section('content')
    <form action="{{ route('compras.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="nro_factura_afectada">
        </div>
        <div class="form-group">
            <label for="total_compras">Total Compras</label>
            <input type="number" step="0.01" class="form-control" name="total_compras" required>
        </div>
        <div class="form-group">
            <label for="compras_sin_derecho_iva">Compras sin Derecho a IVA</label>
            <input type="number" step="0.01" class="form-control" name="compras_sin_derecho_iva">
        </div>
        <div class="form-group">
            <label for="descuento_tgif">Descuento TGIF</label>
            <input type="number" step="0.01" class="form-control" name="descuento_tgif">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="base_impo_contribuyente_alic_red">Base Imponible Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="base_impo_contribuyente_alic_red">
        </div>
        <div class="form-group">
            <label for="alicuota_contribuyente_alic_red">Alicuota Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="alicuota_contribuyente_alic_red">
        </div>
        <div class="form-group">
            <label for="impuesto_iva_contribuyente_alic_red">Impuesto IVA Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="impuesto_iva_contribuyente_alic_red">
        </div>
        <div class="form-group">
            <label for="base_impo_no_contribuyente_alic_red">Base Imponible No Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="base_impo_no_contribuyente_alic_red">
        </div>
        <div class="form-group">
            <label for="alicuota_no_contribuyente_alic_red">Alicuota No Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="alicuota_no_contribuyente_alic_red">
        </div>
        <div class="form-group">
            <label for="impuesto_iva_no_contribuyente_alic_red">Impuesto IVA No Contribuyente Alicuota Reducida</label>
            <input type="number" step="0.01" class="form-control" name="impuesto_iva_no_contribuyente_alic_red">
        </div>
        <div class="form-group">
